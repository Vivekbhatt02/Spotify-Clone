...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img class="invert" width="34" src="img/music.svg" alt="music">
                            <div class="info">
...
//Play next song after ending the first song
...
async function main() {
    ...
    //Attach an event listner to prevoius, play and next
    ...
    // Play next song after ending the first
    ...
    //Add an event listene to previous 
    ...
    // Add event listener to mute te track
